      ...
      <main className="mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-24">
        <div className="mb-12">
          ...
          <p className="max-w-3xl text-lg text-muted-foreground">
            ...
            third-party library worth knowing — with a one-line, plain-English explanation. Jump
            to a category, then ctrl-F your way to the answer.
          </p>
        </div>

        <nav className="mb-12 flex flex-wrap gap-2 border-y border-hairline py-4">
